              ...
              <MockDiscordUI>
                <AnimatedList>
                  ...
                  <DiscordMessage
                    ...
                    avatarAlt="PingPanda avatar"
                    username="PingPanda"
                    timestamp="Today at 05:23PM"
                    badgeText="Milestone"
                    badgeColor="#5865f2"
                    title="🚀 Revenue milestone achieved"
                    content={{ recurringRevenue: "$5,000 USD", growth: "+8%" }}
                  />
                </AnimatedList>
              </MockDiscordUI>
            </div>
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  <div className="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
                    <Image
                      ...
                      alt="Phone Screen displaying app inteface"
                      fill
                    />
                  </div>
                </div>
              ...
              <div className="relative flex h-full  flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                ...
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                  <Image
                    ...
                    alt="Bento box illustarting event tracting"
                    width={500}
                    height={300}
                  />
                </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-22xl">
                    <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                      <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                        <div className="border-b border-r border-b-white/20 border-r-white/10 bg-white-px-4 py-2 text-white">
                          pingpanda.js
                        </div>
                      </div>
                    </div>
